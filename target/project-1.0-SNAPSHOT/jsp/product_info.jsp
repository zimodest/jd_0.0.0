			...
			<div class="row">
				...
				<div style="margin:0 auto;width:950px;">
					<div class="col-md-6">
						...
						<img style="opacity: 1;width:400px;height:350px;" title="" class="medium" src="${pageContext.request.contextPath}/${requestScope.product.pimage}">
					</div>

					<div class="col-md-6">
						<%--<div><strong>大冬瓜</strong></div>--%>
						<div><strong>${requestScope.product.pname}</strong></div>
						...
						<div style="padding:10px;border:1px solid #e7dbb1;width:330px;margin:15px 0 10px 0;;background-color: #fffee6;">
							...
							<div style="margin:20px 0 10px 0;;text-align: center;">
								<%--<a href="cart.htm">--%>
									...
									<a href="${pageContext.request.contextPath}/product?method=addCart&pid=${requestScope.product.pid}">
				...
				<div style="width:950px;margin:0 auto;">
					...
					<div>
						...
						<img src="${pageContext.request.contextPath}/${requestScope.product.pimage}">
					</div>
