	...
	<body>
		...
		<div class="row" style="width:1210px;margin:0 auto;">
            ...
            <c:if test="${not empty requestScope.pb}">
                <c:forEach items="${requestScope.pb.list}" var="product">
                    <div class="col-md-2">
            ...
            <div style="width:380px;margin:0 auto;margin-top:50px;">
                <ul class="pagination" style="text-align:center; margin-top:10px;">
                 ...
                 小于等于  <=    le
                     ...
                     求莫  %     mod
                    --%>
                    <c:forEach var="s" begin="1" end="${requestScope.pb.totalPage}">
                        <li><a href="${pageContext.request.contextPath}/product?method=findByPage&cid=${requestScope.cid}&currentPage=${s}">${s}</a></li>
                    </c:forEach>
                    <li>
